...
>
> **Composition contract (2026-09):** Operational canonical is `composition.v2` (`backend/app/composition_schemas.py`, `docs/composition-v2.md`). V1 remains migration input (`docs/composition-v1.md`).
