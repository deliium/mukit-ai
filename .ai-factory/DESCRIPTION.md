...
- **Logging:** Configurable via `LOG_LEVEL`; structured extras for stage/provider/model/import/analysis codes; never log API keys, full prompts, raw MusicXML/MIDI payloads, upload bytes, or full analysis reports
