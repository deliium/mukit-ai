...
- [ ] Task 4: Implement operation-specific topology realization with explicit canonical notes, deterministic IDs, safe channels, and motif reconciliation.
...
- [ ] Task 5: Add dedicated arrangement preservation, range, harmony, density, duplicate, and postcondition validation.
...
- [ ] Task 6: Implement independent multi-candidate LLM orchestration, bounded repair, and deterministic fake drafts for every operation.
